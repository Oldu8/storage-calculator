...
export const calcPric = (providerName, provider, storage, transfer, itemOption, obj = resultObj,) => {
...
export const updCharts = (providerName, provider, storageValue, transferValue, itemOption) => {
	calcPric(providerName, provider, storageValue, transferValue, itemOption, resultObj)
